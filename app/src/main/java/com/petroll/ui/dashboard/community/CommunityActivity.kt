package com.petroll.ui.dashboard.community
...
import com.petroll.ui.dashboard.community.services.*
...
class CommunityActivity : BaseActivity() {
    ...
    private fun setUpIconLayout() {
        ...
        binding.postLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.green1
            )
        )
        binding.matingLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.pink2
            )
        )
        binding.lostLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.yellow1
            )
        )
        binding.adoptionLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.light_yellow
            )
        )
        binding.postIncidentLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.light_blue2
            )
        )
        binding.helpLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.lighter_yellow
            )
        )
        binding.newsLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.blue3
            )
        )
        binding.guideLayout.setBackgroundColorTint(
            AppCompatResources.getColorStateList(
                this,
                R.color.yellow2
            )
        ...
        binding.matingLayout.setImageText(
            resources.getString(R.string.mating),
            R.drawable.ic_mating
        )
        binding.lostLayout.setImageText(
            resources.getString(R.string.lost_found),
            R.drawable.ic_lost
        )
        binding.adoptionLayout.setImageText(
            resources.getString(R.string.adoption),
            R.drawable.ic_adopt
        )
        binding.postIncidentLayout.setImageText(
            resources.getString(R.string.post_incident),
            R.drawable.ic_post_incident
        )
        binding.helpLayout.setImageText(resources.getString(R.string.find_help), R.drawable.ic_help)
        binding.newsLayout.setImageText(
            resources.getString(R.string.news_event),
            R.drawable.ic_event
        )
        binding.guideLayout.setImageText(resources.getString(R.string.guide), R.drawable.ic_guide)


        binding.postLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.matingLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.lostLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.adoptionLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.postIncidentLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.helpLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.newsLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
        )
        binding.guideLayout.setTextColorLayout(
            AppCompatResources.getColorStateList(
                this,
                R.color.black
            )
